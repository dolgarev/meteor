...
::: info
You can find the final version of this app using the Rspack bundler in our [GitHub repository](https://github.com/meteor/meteor3-svelte/tree/3.4-rspack).
:::

::: info
You can find the final version of this app using the Meteor bundler in our [GitHub repository](https://github.com/meteor/meteor3-svelte/tree/3.4-meteor).
:::
